...
<img src="/assets/images/pcbs/Breakout_Boards/turnout_slow_motion_switch_machine_breakout_board_pcb.png/" style="zoom:70%; float:right" />Below are the high level steps for assembly of the Block Breakout Board:
