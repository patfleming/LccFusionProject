...
| -------------------- | ----- | ----------------- | ------------------------ | ------------- | :------------------ | ------------------- | :----------------------------------------------------------- |
| C1, C2, C3, C4       | 4     | Capacitor         | 100µF                    | 1206 SMD      | Required (C1, C2)   | Required (C3, C4)   | Timing Circuit for PWM 50Hz (period / duty cycle)            |
| C5, C8, C10          | 3     | Capacitor         | 0.33µF Tantalum          | 3216 SMD      | Required (C5, C8)   | Required (C5, C10)  | Used by 5V voltage regulator for input filtering.            |
| C6, C7, C9           | 3     | Capacitor         | 0.1µF                    | 1206 SMD      | Required (C6, C7)   | Required (C6, C9)   | Used by 5V voltage regulator for output filtering.           |
