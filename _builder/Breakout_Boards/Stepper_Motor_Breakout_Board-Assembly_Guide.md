...
<img src="{{ site.baseurl }}/assets/images/pcbs/Breakout_Boards/stepper_motor_breakout_board_pcb.png/" style="zoom:50%; float:right" />Below are the high level steps for assembly of the Stepper Motor Breakout Board:
